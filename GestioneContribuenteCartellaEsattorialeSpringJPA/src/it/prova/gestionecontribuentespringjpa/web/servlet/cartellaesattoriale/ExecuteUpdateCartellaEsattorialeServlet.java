...
//		Contribuente cont = contribuenteService.caricaSingoloContribuente(idInputContribuente);
		...
		cartellaEsattorialeDaInserire.setContribuente(contribuenteService.caricaSingoloContribuente(idInputContribuente));
