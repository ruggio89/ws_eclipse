...
public class UtenteDAOImpl  implements UtenteDAO{
	...
	public Utente getEager(Long id) {
		Query q = entityManager.createQuery("Select a from Utente a left join fetch a.ruoli left join fetch a.acquisti left join fetch a.annunci where a.id=:id");
	...
	public Utente getEagerAnnunci(Long id) {
		Query q = entityManager.createQuery("Select a from Utente a join fetch a.annunci where a.id=:id");
		q.setParameter("id", id);
