package it.prova.ebayspringjpa.web.filter;
...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] EXCLUDED_URLS = {"", "/", "/home", "/login.jsp","/LoginServlet","/LogoutServlet","/css/","/js/"};
	private static final String[] PROTECTED_URLS = {"/admin/", "/utente"};
