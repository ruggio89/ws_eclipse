...
<!-- 			</dl> -->
		...
		<a href="PrepareUpdateAnnuncioUtenteServlet?idAnnuncio=${AnnuncioSingoloAttributeName.id}" class="btn btn-outline-danger">Modifica</a>
		<a href="PrepareDeleteAnnuncioUtenteServlet?idAnnuncio=${AnnuncioSingoloAttributeName.id}" class="btn btn-outline-danger">Elimina</a>
	</div>
</body>
</html>