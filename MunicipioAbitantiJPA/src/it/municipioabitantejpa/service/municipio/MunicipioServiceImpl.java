...
public class MunicipioServiceImpl implements MunicipioService {
	...
	@Override
	public List<Municipio> TrovaAbitantiMinorenni() throws Exception {
		try {
			// uso l'injection per il dao
			municipioDAO.setEntityManager(EntityManagerUtil.getEntityManager());
	...
	@Override
	public List<Municipio> trovaMunicipiCheInizianoCon(String iniziale) throws Exception {
		try {
			// uso l'injection per il dao
			municipioDAO.setEntityManager(EntityManagerUtil.getEntityManager());

			// eseguo quello che realmente devo fare
			return municipioDAO.findAllByIniziaCon(iniziale);
