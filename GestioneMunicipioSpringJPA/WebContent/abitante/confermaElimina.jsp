...
<body>
<%
		Abitante abitanteInPagina = (Abitante) request.getAttribute("abitantedaeliminare_attribute");
	%>
	...
	<%@ include file="../header.jsp" %>
		...
		<div class="page-header">
			<h3>Pagina di Dettaglio per conferma Eliminazione</h3>
		</div>
		...
		<a href="ExecuteDeleteAbitanteServlet?idInput=<%=abitanteInPagina.getId() %>" class="btn btn-outline-danger btn-md">Conferma Eliminazione</a>
		<a href="PrepareSearchAbitanteServlet" class="btn btn-outline-danger btn-md">Torna Indietro</a>
