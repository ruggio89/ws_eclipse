...
public class VisualizzaDettaglioMunicipioServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Long idMunicipioDaPagina = Utility.parseFromStrinToLong(request.getParameter("idMunicipio"));
		Municipio municipioDaPagina = municipioService.caricaSingoloMunicipio(idMunicipioDaPagina);
		request.setAttribute("MunicipioSingoloAttributeName", municipioDaPagina);
