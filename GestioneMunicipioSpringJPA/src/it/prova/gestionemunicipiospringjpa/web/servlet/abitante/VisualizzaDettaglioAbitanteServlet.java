...
public class VisualizzaDettaglioAbitanteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Long idAbitanteDaPagina = Utility.parseFromStrinToLong(request.getParameter("idAbitante"));
		Abitante abitanteDaPagina = abitanteService.caricaSingoloAbitante(idAbitanteDaPagina);
